...
const Header = () => {
  ...
  return (
    <header className="w-full top-0 fixed z-50 px-6 h-16 border-b shadow-sm bg-background/80 backdrop-blur-md border-border flex items-center justify-between">
      <motion.div
